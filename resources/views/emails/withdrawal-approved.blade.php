...
<head>
    ...
    <title>Withdrawal Approved – SmartEarn</title>
    <style>
        body {
            margin: 0;
            padding: 0;
            ...
            <td align="center">
                <div class="email-container">
                    ...
                    <div class="content">
                        ...
                        <p style="font-size:16px; color:#4a5568;">Your withdrawal request has been approved and will be processed shortly.</p>
                        ...
                        <div class="withdrawal-box">
                            ...
                            <div class="detail-row">
                                <span>Date:</span>
                                <strong>{{ $withdrawal->created_at->format('M d, Y. h:i A') }}</strong>
                            </div>
                        </div>

                        <p style="font-size:16px; color:#4a5568;">Thank you for using SmartEarn.</p>
