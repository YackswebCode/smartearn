...
<head>
    ...
    <title>Withdrawal Update – SmartEarn</title>
    <style>
        /* Same styles as approved email */
        body {
            margin: 0;
            padding: 0;
        ...
        <tr>
            <td align="center">
                <div class="email-container">
                    ...
                    <!-- Content -->
                    <div class="content">
                        <p style="font-size:16px; color:#4a5568;">Hello <strong style="color:#065754;">{{ $withdrawal->user->name }}</strong>,</p>
                        <p style="font-size:16px; color:#4a5568;">Your withdrawal request has been reviewed and could not be approved at this time.</p>
                        ...
                        <p style="font-size:16px; color:#4a5568;">If you have any questions, please contact support.</p>
