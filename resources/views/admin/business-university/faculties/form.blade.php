...
@section('title', $faculty->exists ? 'Edit Faculty' : 'New Faculty')

@section('content')
<div class="container-fluid py-4">
    <div class="mb-4">
        <h2 class="fw-bold">{{ $faculty->exists ? 'Edit Faculty' : 'Create Faculty' }}</h2>
    </div>
            ...
            <form action="{{ $formAction }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="icon" class="form-control" value="{{ old('icon', $faculty->icon) }}" placeholder="fas fa-chart-line">
                    </div>
                    <div class="col-12">
                ...
                <div class="mt-4 d-flex justify-content-end gap-2">
                    <a href="{{ route('admin.business-faculties.index') }}" class="btn btn-outline-secondary">Cancel</a>
