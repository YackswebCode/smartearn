...
<div class="container-fluid py-4">
    <!-- Header -->
    <div class="mb-4">
        <h2 class="fw-bold">Top Creators Leaderboard</h2>
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <span class="badge bg-warning text-dark px-3 py-2 fs-6">#1 Creator</span>
...
<div class="card border-0 shadow-sm">
    ...
    @else
        <div class="text-center py-5">
            ...
            <h4>No active Creators found</h4>
            <p class="text-muted">Once Creators start selling, they will appear here.</p>
        </div>
    @endif
</div>
@push('scripts')
