...
class VendorController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        // ----- New dynamic aggregations -----
        $totalProducts = Product::where('vendor_id', $user->id)->count();
        $totalSales = $orders->count();
        $totalCustomers = $orders->pluck('buyer_email')->unique()->count();
        $totalAffiliates = $orders->pluck('affiliate_id')->unique()->filter()->count();
        ...
        // Single top-performing product (best by units sold)
        $topPerformingProduct = $topProducts->first();
