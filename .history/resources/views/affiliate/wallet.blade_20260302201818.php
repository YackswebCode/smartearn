...
<div class="container-fluid py-4">
    ...
    <!-- Action Buttons -->
    <div class="mb-4">
        <a href="{{ route('affiliate.add_funds') }}" class="btn btn-success me-2 mb-2">Add Funds</a>
        <a href="{{ route('affiliate.withdrawals') }}" class="btn btn-outline-success me-2 mb-2">Withdraw from Affiliate Balance</a>
    </div>
