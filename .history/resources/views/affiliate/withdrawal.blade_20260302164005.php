        ...
        <div class="col-lg-7 mb-4">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    ...
                    <!-- Bank Details (if any) -->
                    @if(isset($bankDetails->bank_name) && $bankDetails->bank_name !== 'Not set')
                ...
                <div class="table-responsive">
                    <table id="transactions-table" class="table table-hover align-middle">
                        ...
                        <tbody>
                          ...
                          @empty
                            <tr>
                                <td colspan="5" class="text-center">No withdrawal transactions found.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
...
document.addEventListener('DOMContentLoaded', function() {
    // Toggle between bank and momo fields
