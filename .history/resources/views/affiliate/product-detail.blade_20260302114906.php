    ...
    <div class="row mb-4 mt-4">
        ...
        <div class="col-12 mt-4">
            ...
            <div class="col-12 col-md-12">
                ...
                @php
                    $baseUrl = config('app.url'); // e.g., http://localhost:8000
                    $affiliateId = auth()->id();
                ...
                <div class="input-group mb-2">
                    <input type="text" class="form-control" value="{{ $baseUrl }}/aff/{{ $affiliateId }}/{{ $productKey }}" readonly>
                ...
                <div class="input-group mb-2">
                    <input type="text" class="form-control" value="{{ $baseUrl }}/webinar/{{ $affiliateId }}/{{ $productKey }}" readonly>
                    <button class="btn btn-outline-secondary" onclick="copyToClipboard(this)">
                        <i class="fas fa-copy"></i>
                    </button>
                </div>
                ...
                <div class="input-group mb-2">
                    <input type="text" class="form-control" value="{{ $baseUrl }}/pay/{{ $affiliateId }}/{{ $productKey }}" readonly>
                    <button class="btn btn-outline-secondary" onclick="copyToClipboard(this)">
                        <i class="fas fa-copy"></i>
                    </button>
                </div>
