...
<div class="row mb-4">
    ...
    <div class="row mb-4 mt-4">
        ...
        <div class="col-12 mt-4">
             ...
             <div class="card border-0 shadow-sm p-3 d-flex flex-column justify-content-center" style="background-color: #065754; color: white;">
                <!-- Scrollable Vendor Info Row -->
                <div class="d-flex overflow-auto mb-3" style="gap: 1rem;">
                    <div class="p-2 border rounded flex-shrink-0">
