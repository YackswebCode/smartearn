...
<div class="container-fluid py-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="accordion" id="courseAccordion">
                ...
                <div class="section-item">
                    <div class="section-header" data-bs-toggle="collapse" data-bs-target="#collapse{{ $index }}" aria-expanded="true">
    ...
    <!-- Pagination / Navigation (not needed for detail page, but you can add related courses later) -->
</div>

<!-- Optional: Add smooth scroll for sticky sidebar -->
<script>
    // Ensure accordion functionality works
    document.addEventListener('DOMContentLoaded', function() {
        // Bootstrap handles collapse via data attributes
    });
</script>
@endsection