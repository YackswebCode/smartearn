...
<div class="container-fluid py-4">
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3" style="background-color: #065754; color: white;">
        ...
        <div class="col-lg-4">
            <div class="card green-card sticky-lg-top" style="top: 2rem;">
                <div class="card-body">
                    <!-- Price and Discount -->
