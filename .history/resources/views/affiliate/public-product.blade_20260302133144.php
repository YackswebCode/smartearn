...
<body>
            ...
            <div class="col-md-8 col-lg-6">
                <div class="product-card">
                    ...
                    <div class="p-4">
                        ...
                        <!-- Buyer Name Field -->
                        <div class="mb-3">
                            <label for="buyerName" class="form-label fw-bold">Your Full Name</label>
                            <input type="text" class="form-control" id="buyerName" placeholder="John Doe" required>
                        </div>
    ...
    <script>
        ...
        function initiateFlutterwavePayment() {
            ...
            console.log('Initializing Flutterwave with:', { name, email, currency, amount, reference });
                ...
                try {
                    FlutterwaveCheckout({
                        ...
                        customizations: {
                            ...
                            logo: 'https://flutterwave.com/images/logo/full.svg', // replace with your logo
                        },
                        callback: function(response) {
                            console.log('Flutterwave callback:', response);
                            btn.innerHTML = '<i class="fas fa-spinner fa-spin me-2"></i> Processing...';
                            handlePaymentSuccess(response.transaction_id, reference, currency, amount, name, email);
                        },
                        onclose: function() {
        ...
        function handlePaymentSuccess(transactionId, reference, currency, amount, name, email) {
            const btn = document.getElementById('payNowBtn');
            console.log('Sending verification:', { transactionId, reference, currency, amount, name, email });
