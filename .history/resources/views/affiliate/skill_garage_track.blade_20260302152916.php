...
<style>
    ...
    .section-header {
        background-color: #065754; /* dark green */
        ...
        <div class="col-lg-8">
            ...
            <div class="card green-card mb-4" style="background-color: #065754; color: white;">
                <div class="card-body">
                    ...
                    <!-- Faculty & Meta -->
                    <p class="mb-2">
                        <strong>Faculty</strong> {{ $track->faculty->name }}
                    </p>
                    @if($track->duration_months)
                        <p class="mb-2">
                            <strong>Duration</strong> {{ $track->duration_months }} months
                        </p>
                    @endif
                </div>
            </div>
        ...
        <div class="col-lg-4 mt-5 mb-5">
            <div class="card green-card sticky-lg-top" style="top: 2rem; background-color: #065754; color: white; border: solid 4px #89efbfff; ">
                <div class="card-body">
                    ...
                    <!-- This Program Includes (same as mobile) -->
...
<script>
    // Optional: toggle chevron icon on collapse
