...
<head>
    ...
    <style>
        /* Inline styles are used, but we keep a minimal style block for readability */
        body {
            margin: 0;
            padding: 0;
        ...
        <tr>
            <td align="center">
                <div class="email-container">
                    ...
                    <!-- Content -->
                    <div class="content">
                        <p style="font-size:16px; color:#4a5568;">Hello <strong style="color:#065754;">{{ $order->user->name }}</strong>,</p>
                        ...
                        <p style="font-size:16px; color:#4a5568;">You can access your product anytime from your dashboard.</p>

                        <div style="text-align: center;">
                            <a href="{{ route('affiliate.dashboard') }}" class="button">Go to Dashboard</a>
                        </div>
                    </div>
