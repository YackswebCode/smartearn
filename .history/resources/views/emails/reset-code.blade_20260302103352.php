...
<head>
    ...
    <title>SmartEarn – Reset Your Password</title>
</head>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <tr>
                                        <td align="center" style="background-color:#EEF0F8; border-radius:16px; padding:24px; margin:10px 0;">
                                            <span style="font-size:14px; text-transform:uppercase; letter-spacing:2px; color:#065754; font-weight:600;">Reset code</span>
                                    ...
                                    <tr>
                                        <td align="center" style="padding:16px 0 8px;">
                                            <table width="60px" cellpadding="0" cellspacing="0" border="0">
                                                <tr><td style="height:2px; background-color:#EEF0F8;"></td></tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
