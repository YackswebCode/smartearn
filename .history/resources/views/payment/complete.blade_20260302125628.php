        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <p class="lead">Thank you for your purchase, <strong>{{ auth()->user()->name }}</strong>.</p>
                    <p>Your order has been confirmed and you will receive an email with the product details shortly.</p>
                    ...
                    <div class="text-center mt-4">
                        <a href="{{ route('affiliate.dashboard') }}" class="btn btn-primary">Go to Dashboard</a>
                    </div>
                </div>
            </div>
        </div>
