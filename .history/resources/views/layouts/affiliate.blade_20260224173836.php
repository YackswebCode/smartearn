    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-green text-white" id="sidebar-wrapper" style="min-width: 250px; background-color: #065754;">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="{{ route('affiliate.profile.edit') }}" class="list-group-item list-group-item-action bg-transparent text-white">
                ...
                <!-- Group 3 -->
                <a href="{{ route('affiliate.withdrawals') }}" class="list-group-item list-group-item-action bg-transparent text-white">
                    <i class="fas fa-wallet me-3"></i>Withdraw Funds
                </a>
                <hr class="my-2">
