                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0" style="border-radius: 12px; padding: 0.5rem 0;">
                                    <li><a class="dropdown-item py-2" href="{{ route('affiliate.dashboard') }}"><i class="bi bi-speedometer2 me-2" style="color: var(--primary-green);"></i> Dashboard</a></li>
                                    <li><a class="dropdown-item py-2" href="{{ route('affiliate.wallet') }}"><i class="bi bi-wallet2 me-2" style="color: var(--primary-green);"></i> Wallet</a></li>
