...
Route::prefix('affiliate')->name('affiliate.')->middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/withdrawals', [App\Http\Controllers\Affiliate\WithdrawalController::class, 'store'])->name('withdrawals.store');
...
Route::get('/business-university/course/{slug}', [BusinessUniversityController::class, 'showCourse'])->name('business.course');
Route::post('/business-university/course/{id}/enroll', [BusinessUniversityController::class, 'enroll'])->name('business.enroll');
Route::get('/business-university/my-learning', [BusinessUniversityController::class, 'myLearning'])->name('business.my_learning');
Route::get('/business-university/learning/{id}', [BusinessUniversityController::class, 'learningCourse'])->name('business.learning.course');

    Route::get('/my-learning', [App\Http\Controllers\Affiliate\MyLearningController::class, 'index'])->name('my_learning');
Route::get('/my-learning/{id}', [App\Http\Controllers\Affiliate\MyLearningController::class, 'show'])->name('learning.track');
    // Add funds
Route::get('/add-funds', [App\Http\Controllers\Affiliate\AddFundsController::class, 'index'])->name('add_funds');
Route::post('/add-funds/verify', [App\Http\Controllers\Affiliate\AddFundsController::class, 'verify'])->name('add_funds.verify');
