...
class DigitalUniversitySeeder extends Seeder
{
    public function run()
    {
        ...
        $design = Faculty::create([
            'name' => 'Faculty of Product and Design',
            'description' => 'Create impactful products and designs.',
        ...
        $business = Faculty::create([
            'name' => 'Faculty of Business and Marketing',
            'description' => 'Master the art of business and marketing.',
