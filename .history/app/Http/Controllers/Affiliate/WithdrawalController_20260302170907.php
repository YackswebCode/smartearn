...
class WithdrawalController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Check if affiliate balance is sufficient
        ...
        DB::transaction(function () use ($user, $amountInNGN, $feeInNGN, $totalDeduction, $amount, $userCurrency, $request) {
            // 1. Save or update bank account details
            ...
            $transaction = Transaction::create([
                ...
                'description' => "Withdrawal request to " . ($request->account_type == 'bank' ? 'bank' : 'mobile money'),
                'reference' => 'WD_' . uniqid(),
                'payment_gateway' => null,
                'status' => 'pending', // transaction is pending until admin approval
                'meta' => [
            ...
            // 4. Create withdrawal record for admin tracking
            Withdrawal::create([
                'user_id' => $user->id,
                'amount' => $amountInNGN,
                'currency' => 'NGN',
