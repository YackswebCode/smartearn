...
class PaymentController extends Controller
{
    ...
    public function verify(Request $request)
    {
        ...
        // Verify transaction with Flutterwave (implement properly later)
        ...
        // Calculate earnings (all in NGN base)
        ...
        try {
            ...
            // Send emails (use buyer_email for buyer)
